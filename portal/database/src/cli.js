...
const TABLES = ['jsan_users', 'jsan_conversations', 'jsan_messages', 'jsan_message_images', 'jsan_login_attempts',
  'jsan_access_codes', 'jsan_access_code_redemptions', 'jsan_password_resets', 'jsan_disabled_users'];
